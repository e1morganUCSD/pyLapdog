function [ filtcomparison, antiphase_filtcomparison ] = compare_filters( filter1, filter2 )
...
antiphase_filtcomparison = zeros(size(filtcomparison));
...
% pad filter 2 with sufficient zeros all around
