...
class FilterParams:
    ...
    def __init__(self):
        ...
        self.filt_negwidth = 1.0    # std ratio of negative surround to center,
        # == 1 in ODOG
        self.filt_neglen = 2.0      # std ratio of negative surround to center,
        # == 2 in ODOG
        self.filt_centerW = 1.0  # weight on center gaussian, >1 = positive sum
        # gaussian. == 1 in ODOG
        ...
        self.filt_stdev_pixels = [x * self.const_SPACE_CONST_TO_STD for x in
                                  self.space_const]  # in pixels
        ...
        self.cpd = [1.0 / (2.0 * x * self.const_SPACE_CONST_TO_WIDTH) for x in
                    self.space_const_deg]
